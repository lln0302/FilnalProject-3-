...
<div class="row">
	...
	<form method="post" action="/car/carEditOk" id="cwFrm">
		<input type="hidden" name="carno" value="${vo.carno }"/>
		<input type="hidden" id="preRegion" value="${vo.region }"/>
		...
		<div id="carMapWrap" class="col-5">
			<table id="cwTable">
				<tr>
					...
					<td><input type="text" id="locX" name="locX" value="${vo.locX }" placeholder="위도 값을 입력"/></td>
					<td><input type="text" id="locY" name="locY" value="${vo.locY }" placeholder="경도 값을 입력"/></td>
		...
		<div id="carWriteWrap" class="col-7">
			<input type="text" id="carName" name="title" placeholder="제목을 입력하세요" value="${vo.title }"/><hr style="margin:16px 0"/>
...
<script src="/js/car/carEdit.js"></script>